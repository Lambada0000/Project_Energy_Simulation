...
class TransmissionLine(models.Model):
    ...
    length = models.FloatField(
        verbose_name="Длина линии (км)",
        help_text="Укажите длину линии в километрах"
    )
...
class NetworkNode(models.Model):
    ...
    name = models.CharField(
        ...
        help_text="Укажите название узла"
    )
...
class Load(models.Model):
    ...
    name = models.CharField(
        ...
        help_text="Укажите название нагрузки"
    )
    power_demand = models.FloatField(
        verbose_name="Требуемая мощность (кВт)",
        help_text="Укажите мощность нагрузки"
    )
...
class Generator(models.Model):
    ...
    name = models.CharField(
        ...
        help_text="Укажите название генератора"
    )
